...
This checklist is a technical compliance guardrail for Continuuuum + USC integrations. It is not legal certification and does not replace counsel review.
...
- [ ] `LICENSE` remains MIT in Continuuuum and Apache-2.0 in USC.
