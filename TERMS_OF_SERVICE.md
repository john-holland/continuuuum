# Continuuuum Terms of Service (Project Draft)
...
Continuuuum is provided for development and operational workflows around library/document/media services and related research features.

## Entropy and Randomness Claims

When entropy-related features are enabled, Continuuuum makes only conservative, measured-condition claims:

- Continuuuum improves unpredictability under measured conditions when probe evidence requirements are satisfied.
- Continuuuum does not guarantee universal or perpetual randomness quality.
- Continuuuum does not represent outputs as legally certified "true random."

## Infrastructure Stability Baseline

Continuuuum may use common DNS/edge infrastructure measurements as a baseline:
